...
<title>Biometrická autentifikácia - obnovenie hesla</title>
...
<div class="container">
 ...
 <div id="login-form">
   ...
   ?>
            ...
            <div class="form-group">
             <button type="submit" class="btn btn-block btn-primary" name="btn-signup">Obnovenie hesla</button>
            </div>
